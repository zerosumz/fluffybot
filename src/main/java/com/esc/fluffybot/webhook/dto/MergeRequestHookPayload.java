...
public class MergeRequestHookPayload {
    ...
    /**
     * 봇이 생성한 MR인지 확인 (description에 봇 시그니처 포함)
     */
    public boolean isCreatedByBot() {
        return objectAttributes != null &&
               objectAttributes.getDescription() != null &&
               objectAttributes.getDescription().contains(":robot: Generated by fluffybot");
    }
